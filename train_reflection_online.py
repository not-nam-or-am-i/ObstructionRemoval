...
def train():
    ...
    with tf.Graph().as_default():
        ...
        batch_online_I0 = tf.compat.v1.data.make_initializable_iterator(dataset_online_I0.batch(FLAGS.batch_size))
        batch_online_I1 = tf.compat.v1.data.make_initializable_iterator(dataset_online_I1.batch(FLAGS.batch_size))
        batch_online_I2 = tf.compat.v1.data.make_initializable_iterator(dataset_online_I2.batch(FLAGS.batch_size))
        batch_online_I3 = tf.compat.v1.data.make_initializable_iterator(dataset_online_I3.batch(FLAGS.batch_size))
        batch_online_I4 = tf.compat.v1.data.make_initializable_iterator(dataset_online_I4.batch(FLAGS.batch_size))
